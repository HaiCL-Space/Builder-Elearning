...
| `pages` | High-level page-composing views (`builder-page.tsx`, `viewer-page.tsx`, `LoginPage.tsx`) that bundle features and entities together. | Generic UI button styles, low-level domain math helpers. |
