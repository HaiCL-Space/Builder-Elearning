...
| broker-core-sdk | ^1.0.3 | Interactive educational game & learning engines | `package.json` |
...
- **Required env vars**: None. This is a fully client-side application. No environment variables are used or required.
- **Deployment/runtime constraints**: Completely client-side Single Page Application (SPA). Requires a modern browser with Javascript support. No server-side runtime constraints.
